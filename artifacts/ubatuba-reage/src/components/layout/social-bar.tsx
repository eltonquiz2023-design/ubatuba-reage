...
export const WhatsAppChannelIcon = ({ className }: { className?: string }) => (
...
export function SocialBar({ compact = false }: SocialBarProps) {
  if (compact) {
    return (
      <div className="bg-[#0a0a0a] border-t border-white/5 flex items-center justify-center gap-0 px-2 h-[28px]">
